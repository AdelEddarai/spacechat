  ...
  return (
    <Link href={`/chats/${id}`}>
      <div
        ...
        className={cn(
          "py-4 w-full mb-2 relative flex items-center border border-neutral-200 dark:border-neutral-800 space-x-3 bg-white dark:bg-neutral-925 p-3 hover:bg-neutral-100 dark:hover:bg-neutral-800/60 rounded-lg transition",
